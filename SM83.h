...
public:
    ...
    uint8_t ld_de_d16(); uint8_t ld_e_a();  uint8_t ld_e_abs_hl();  uint8_t ld_e_b(); uint8_t ld_e_c(); uint8_t ld_e_d(); uint8_t ld_e_d8(); uint8_t ld_e_e(); uint8_t ld_e_h(); uint8_t ld_e_l(); uint8_t ld_h_b(); uint8_t ld_h_d8();   uint8_t ld_hl_d16();    uint8_t ld_l_d8();  uint8_t ld_sp_d16();  uint8_t rla();              uint8_t rlca();            uint8_t rra();             uint8_t rrca();      uint8_t scf();      uint8_t stop_d8();
