...
public:
    ...
    uint8_t stop_d8(); uint8_t sub_a(); uint8_t sub_abs_hl(); uint8_t sub_b(); uint8_t sub_c(); uint8_t sub_d(); uint8_t sub_d8(); uint8_t sub_e(); uint8_t sub_h(); uint8_t sub_l(); uint8_t swap_b();
