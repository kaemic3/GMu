...
public:
    ...
    uint8_t nop(); uint8_t add_hl_bc(); uint8_t dec_b(); uint8_t inc_b(); uint8_t inc_bc(); uint8_t ld_a_abs_bc(); uint8_t ld_abs_a16_sp(); uint8_t ld_abs_bc_a();  uint8_t ld_b_d8(); uint8_t ld_bc_d16(); uint8_t rlca();
