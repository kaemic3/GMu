...
public:
    ...
    uint8_t rla();  uint8_t rlca(); uint8_t rlc_b(); uint8_t rra(); uint8_t rrca(); uint8_t rst_00h(); uint8_t sbc_a_a(); uint8_t sbc_a_abs_hl();  uint8_t sbc_a_b(); uint8_t sbc_a_c(); uint8_t sbc_a_d(); uint8_t sbc_a_e(); uint8_t sbc_a_h(); uint8_t sbc_a_l();  uint8_t scf();
