...
SM83::SM83() {
    ...
    prefix_lookup =
    {
            ...
            {"SET 0,B", &op::set_n_r8, 4, 2, {&b_reg}, 0}, {"SET 0,C", &op::set_n_r8, 4, 2, {&c_reg}, 0}, {"SET 0,D", &op::set_n_r8, 4, 2, {&d_reg}, 0}, {"SET 0,E", &op::set_n_r8, 4, 2, {&e_reg}, 0}, {"SET 0,H", &op::set_n_r8, 4, 2, {&h_reg}, 0}, {"SET 0,L", &op::set_n_r8, 4, 2, {&l_reg}, 0}, {"SET 0,(HL)", &op::set_n_r8, 12, 2, {&l_reg, &h_reg}, 0}, {"SET 0,A", &op::set_n_r8, 4, 2, {&a_reg}, 0}, {"SET 1,B", &op::set_n_r8, 4, 2, {&b_reg}, 1}
    };
}
