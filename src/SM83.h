...
public:
    ...
    uint8_t bit_0_a(); uint8_t bit_0_abs_hl(); uint8_t bit_0_b(); uint8_t bit_0_c(); uint8_t bit_0_d(); uint8_t bit_0_e(); uint8_t bit_0_h(); uint8_t bit_0_l(); uint8_t bit_1_a(); uint8_t bit_1_abs_hl(); uint8_t bit_1_b(); uint8_t bit_1_c(); uint8_t bit_1_d(); uint8_t bit_1_e(); uint8_t bit_1_h(); uint8_t bit_1_l(); uint8_t bit_2_a(); uint8_t bit_2_abs_hl(); uint8_t bit_2_b(); uint8_t bit_2_c(); uint8_t bit_2_d(); uint8_t bit_2_e(); uint8_t bit_2_h(); uint8_t bit_2_l(); uint8_t bit_3_a(); uint8_t bit_3_abs_hl(); uint8_t bit_3_b(); uint8_t bit_3_c(); uint8_t bit_3_d(); uint8_t bit_3_e(); uint8_t bit_3_h(); uint8_t bit_3_l(); uint8_t bit_4_a(); uint8_t bit_4_abs_hl(); uint8_t bit_4_b(); uint8_t bit_4_c(); uint8_t bit_4_d(); uint8_t bit_4_e(); uint8_t bit_4_h(); uint8_t bit_4_l(); uint8_t bit_5_a(); uint8_t bit_5_abs_hl(); uint8_t bit_5_b(); uint8_t bit_5_c(); uint8_t bit_5_d(); uint8_t bit_5_e(); uint8_t bit_5_h(); uint8_t bit_5_l(); uint8_t bit_6_a(); uint8_t bit_6_abs_hl(); uint8_t bit_6_b(); uint8_t bit_6_c(); uint8_t bit_6_d(); uint8_t bit_6_e(); uint8_t bit_6_h(); uint8_t bit_6_l(); uint8_t bit_7_a(); uint8_t bit_7_abs_hl(); uint8_t bit_7_b(); uint8_t bit_7_c(); uint8_t bit_7_d(); uint8_t bit_7_e(); uint8_t bit_7_h(); uint8_t bit_7_l();
